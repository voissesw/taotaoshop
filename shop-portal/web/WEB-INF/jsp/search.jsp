...
<!-- header end -->
<div class="w main">
    <div class="crumb">全部结果&nbsp;&gt;&nbsp;<strong>"${q}"</strong></div>
    <div class="clr"></div>
                ...
                <li class="item-book" bookid="11078102">
                    <div class="p-img">
                        <a target="_blank" href="/item/${item.id }.html">
                            <img width="160" height="160" data-img="1" data-lazyload="${item.item_image_ramdom[0]}"/>
                        </a>
                    </div>
                    <div class="p-name">
                        <a target="_blank" href="/item/${item.id }.html">
                    ...
                    <div class="p-price">
                        ...
                        <strong>￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2"
                                                   value="${item.item_price / 100 }"/></strong>
                    </div>
